...
Ground::Ground(float up_coord, float down_coord) {
    float center = (up_coord+down_coord)/2;
    float division = down_coord + ((up_coord-down_coord)*5)/6;
